...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { image_url: @slide.image_url, link_url: @slide.link_url, order: @slide.order }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { image_url: @slide.image_url, link_url: @slide.link_url, order: @slide.order }
    assert_redirected_to slide_path(assigns(:slide))
  end
